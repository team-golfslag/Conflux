...
public class TestAuthorizationFilter : IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        var accessControlAttribute = endpoint?.Metadata.GetMetadata<AccessControlFilterAttribute>();
        ...
        var routeParamNameAttribute = endpoint?.Metadata.GetMetadata<RouteParamNameAttribute>();
