    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Url);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductsUrl = table.Column<string>(type: "text", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProject", x => new { x.ProductsUrl, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_ProductProject_Products_ProductsUrl",
                        column: x => x.ProductsUrl,
