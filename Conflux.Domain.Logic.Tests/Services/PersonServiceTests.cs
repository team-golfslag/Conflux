...
public class PersonServiceTests : IAsyncLifetime
{
    ...
    public async Task GetPersonById_ShouldReturnPerson_WhenPersonExists()
    {
        ...
        // Act
        Person person = await personService.GetPersonByIdAsync(personId);
    ...
    public async Task GetPersonById_ShouldReturnNotFound_WhenPersonDoesNotExist()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<PersonNotFoundException>(() => personService.GetPersonByIdAsync(personId));
    }
    ...
    public async Task CreatePerson_ShouldCreatePerson()
    {
        ...
        // Act
        Person person = await personService.CreatePersonAsync(testPerson);
        await _context.SaveChangesAsync();
