...
public class Tests
{
                              ...
                              "data": [
                                  {
                                      ...
                                      "type": "repoItem",
                                      "id": "d594e921-4a0b-4d7e-be90-cf27eb31afb1"
                                  }
                              ]
                          }
                          """;
    ...
    [Test]
    public void surfShareKittester()
    {
        const string token = "VeryValidToken";
        FakeHttpMessageHandler handler = new("Something/Invalid", HttpStatusCode.NotFound);
        ...
        List<SURFSharekitRepoItem> result = client.GetAllRepoItems().Result;
